...
| 2026-02-23 | Claude | **Cross-ref: Post-Onboarding "Wow" Experience.** Overview page redesigned with hero stats, top insights, and domain intelligence surfaced from justification pipeline data. New "ADRs" and "Glossary" tabs added to repo navigation. See [PHASE_POST_ONBOARDING_WOW_EXPERIENCE.md](./PHASE_POST_ONBOARDING_WOW_EXPERIENCE.md). |
| 2026-02-28 | Claude | **Cross-ref: UI Consolidation.** "Issues" tab renamed to "Overview". Code tab rebuilt with annotated code viewer (justifications interleaved with code). 5 activity tabs consolidated into 1 unified Activity tab with pipeline run detail pages. See [PHASE_POST_ONBOARDING_WOW_EXPERIENCE.md](./PHASE_POST_ONBOARDING_WOW_EXPERIENCE.md) — Phases 2.5, 2.6. |

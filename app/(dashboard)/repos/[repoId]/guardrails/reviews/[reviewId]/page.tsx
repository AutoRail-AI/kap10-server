...
export default function GuardrailsReviewDetailPage() {
  ...
  if (!review) {
    return <div className="text-muted-foreground">Review not found</div>
  }

  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2 text-sm text-muted-foreground">
        <Link href={`/repos/${repoId}/guardrails/reviews`} className="hover:text-foreground flex items-center gap-1">

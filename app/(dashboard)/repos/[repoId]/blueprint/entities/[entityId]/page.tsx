  ...
  return (
    <div className="space-y-4">
      <nav className="flex items-center gap-1.5 text-sm">
        ...
        <ChevronRight className="h-3.5 w-3.5 text-muted-foreground" />
        <Link href={`/repos/${repoId}/blueprint/entities`} className="text-muted-foreground hover:text-foreground transition-colors">
          Entities
        </Link>
        <ChevronRight className="h-3.5 w-3.5 text-muted-foreground" />
...
export default async function BlueprintEntityDetailPage({
  params,
}: {

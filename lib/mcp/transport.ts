...
import { getProtectedResourceMetadata, getAuthorizationServerMetadata } from "./oauth/discovery"
import { registerClient, isDcrError, type DcrRequest } from "./oauth/dcr"

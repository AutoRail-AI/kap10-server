...
describe("indexing-heavy activities", () => {
  ...
  describe("runSCIP", () => {
    it("returns empty entities and edges (stub)", async () => {
  ...
  describe("parseRest", () => {
    it("returns empty extra entities and edges (stub)", async () => {
...
describe("indexing-light activities", () => {
  ...
  describe("writeToArango", () => {
    it("writes entities and edges via graphStore and updates repo status", async () => {
      ...
      expect(bulkEntitiesSpy).toHaveBeenCalledWith("org-1", entities)
      expect(bulkEdgesSpy).toHaveBeenCalledWith("org-1", edges)
